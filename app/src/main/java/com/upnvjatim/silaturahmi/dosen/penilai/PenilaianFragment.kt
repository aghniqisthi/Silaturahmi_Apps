...
import com.upnvjatim.silaturahmi.databinding.FragmentPenilaianBinding
...
class PenilaianFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewmodel.callApiPendaftarProgram(
            ...
            pageNumber = 1, pageSize = 100, status = "3",
...
//        viewmodel.getliveDataPendaftarProgram().observe(viewLifecycleOwner) {
            if (it != null) {
                ...
                binding.recyclerView.adapter = AccVerifNilaiAdapter(it.data?.items!!)
            } else {
